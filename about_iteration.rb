...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # this is a initial value of the first argument of the method
    # we have not to do initialisation "sum" and "profuct" variables
  ...
  # may be we don't wanted to use the "file" variable in another place in the program
